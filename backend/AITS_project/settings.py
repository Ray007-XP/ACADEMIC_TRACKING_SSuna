...
ALLOWED_HOSTS = ['academictrackingssuna-production.up.railway.app']
...
DATABASES = {
    'default': dj_database_url.config(conn_max_age=600, default='sqlite:////path/to/persistent/db.sqlite3')
}
